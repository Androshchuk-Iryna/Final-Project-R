...
taxi_url <- "https://d37ci6vzurychx.cloudfront.net/trip-data/fhvhv_tripdata_2024-12.parquet"
# taxi_file <- "fhvhv_tripdata_2024-12.parquet"
zones_file <- "taxi_zone_lookup.csv"

#if (!file.exists(taxi_file)) {
#   message("Downloading taxi data (this may take a few minutes)...")
#   download.file(taxi_url, taxi_file, mode = "wb")
